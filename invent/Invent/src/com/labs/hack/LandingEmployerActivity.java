...
public class LandingEmployerActivity extends DroidGap{
    String landingUrl="";
    ...
    private void bump() {
    	landingUrl="http://jwolfe.ausoff.indeed.net:3000/landing/employer/1";  //Should actually be data from the bump
    }
